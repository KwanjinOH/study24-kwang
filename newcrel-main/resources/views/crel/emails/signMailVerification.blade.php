                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" style="width:100%;margin:0;padding:0;background:#fff">
                                                <tbody>
                                                    ...
                                                    <tr><td width="20"></td><td align="left" style="font-family:\'나눔고딕\',NanumGothic,\'맑은고딕\',Malgun Gothic,\'돋움\',Dotum,Helvetica,\'Apple SD Gothic Neo\',Sans-serif;font-size:29px;font-weight:bold;color:#666;line-height:35px"><span style="color:#6F6F6E">회원가입</td><td width="20"></td></tr>
                                                    <tr><td height="22" colspan="3"></td></tr>
                                                    <tr><td width="20"></td><td align="left" style="font-family:\'나눔고딕\',NanumGothic,\'맑은고딕\',Malgun Gothic,\'돋움\',Dotum,Helvetica,\'Apple SD Gothic Neo\',Sans-serif;font-size:14px;color:#333;line-height:25px"><span style="color:#ff1414">{{ $details['email'] }}</span> 님<br> 가입을 환영합니다.</td><td width="20"></td></tr>
                                                    <tr><td height="10" colspan="3"></td></tr>
                                                    <tr><td width="20"></td><td align="left" style="font-family:\'나눔고딕\',NanumGothic,\'맑은고딕\',Malgun Gothic,\'돋움\',Dotum,Helvetica,\'Apple SD Gothic Neo\',Sans-serif;font-size:14px;color:#333;line-height:25px">아래 인증 번호를 회원가입 인증 번호란에 입력해 주시기 바랍니다.</td><td width="20"></td></tr>
